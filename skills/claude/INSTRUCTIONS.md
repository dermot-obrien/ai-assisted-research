# Research Management System (RMS) - Claude Protocol (Redirection)

Claude agents should follow the centralized RMS agent definitions for all research tasks.
...
## Core Guidelines
Follow the mandatory [**User Guide**](.ai-assisted-research/docs/user-guide.md) and the [**Research Principles**](.ai-assisted-research/docs/PRINCIPLES.md).
